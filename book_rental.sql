...
CREATE TABLE `book_item`  (
  ...
  `bname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '书名',
  `price` float(20, 1) NULL DEFAULT NULL COMMENT '单价',
...
CREATE TABLE `customer_info`  (
  ...
  `deposit` int(10) NOT NULL COMMENT '押金金额',
...
CREATE TABLE `order_info`  (
  ...
  `uname` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '顾客姓名',
  `ISBN` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT 'ISBN',
  `bname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '租书书名',
